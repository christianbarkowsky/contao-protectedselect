...
class ProtectedOptionWizard extends OptionWizard
{
  ...
  <tbody class="sortable">';
    ...
    <tr>
      ...
      <td><input type="text" name="' . $this->strId . '[' . $i . '][label]" id="' . $this->strId . '_label_' . $i . '" class="tl_text" value="' . StringUtil::specialchars($this->varValue[$i]['label']) . '" style="width: auto" /></td>
